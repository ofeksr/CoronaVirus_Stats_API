...
class MyTestCase(unittest.TestCase):
    def test_search_json_by_date(self):
        self.assertTrue(get_json_path_by_date(date='09.03.2020'))
    ...
    def test_get_records_by_country_from_dataframe(self):
        ...
        self.assertIsNotNone(get_records_by_country_from_dataframe(df, 'Italy'))

    def test_get_records_from_database(self):
        self.assertIsNotNone(get_records_from_database(specific_date='09.03.2020',
                                                       country='China'))
